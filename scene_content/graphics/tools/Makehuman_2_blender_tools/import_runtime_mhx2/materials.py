...
def buildMaterialCycles(mat, mhMat, scn, cfg):
    ...
    # @ssq edit as per change suggested by  https://developer.blender.org/rBA73df2edf635eee24a2c7a67068acd4d9410de9e5
    if normalTex:
        if normalTex.image:
            normalTex.image.colorspace_settings.is_data = True
