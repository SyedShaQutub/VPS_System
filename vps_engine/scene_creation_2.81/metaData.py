...
labels = [
    ...
    Label(  'road'                 ,  7 ,        0 , 'flat'            , 1       , False        , False        , (128, 64,128) , ['line', 'road']         ),
    ...
    Label(  'pole'                 , 17 ,        5 , 'object'          , 3       , False        , False        , (153,153,153) , ['pole', 'poles']         ),
    Label(  'polegroup'            , 18 ,      255 , 'object'          , 3       , False        , True         , (153,153,153) , ['polegroup']    ),
    Label(  'traffic light'        , 19 ,        6 , 'object'          , 3       , False        , False        , (250,170, 30) , ['trafficLight', 'traffic_light']),
    Label(  'traffic sign'         , 20 ,        7 , 'object'          , 3       , False        , False        , (220,220,  0) , ['trafficSign', 'traffic_sign']),
    ...
    Label(  'person'               , 24 ,       11 , 'human'           , 6       , True         , False        , (220, 20, 60) , ['male', 'dress', 'female', 'Le Femme', 'Hair', 'amorHair', 'LeFemme']  ),
